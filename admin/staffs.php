<?php /* AUTO-GENERATED SB Admin 2 wrapper */ ?>
...
<div class="sb2-content d-flex flex-column min-vh-100">
  <div class="container-fluid py-3 flex-grow-1">
    ...
    function roleBadgeClass($r)
    {
      ...
      if (strpos($r, 'entren') !== false || strpos($r, 'trainer') !== false)
        return 'badge-info';
      if (strpos($r, 'recep') !== false)
    ...
    <div class="container-fluid py-3 flex-grow-1">
      ...
      <div class="d-flex justify-content-end mb-3">
        <a href="registro_staff.php" class="btn btn-primary btn-sm btn-add-staff" style="border-radius:999px;">
                      ...
                      <td class="actions">
                        <div class="btn-group btn-group-sm" role="group" aria-label="Acciones">
                          <a href="form_act_staff.php?id=<?php echo (int) $row['user_id']; ?>"
                            class="btn btn-outline-primary" title="Actualizar">
                            <i class="fas fa-edit"></i>
                          </a>


                          <button type="button" class="btn btn-danger btn-sm btn-delete-staff"
