<?php /* AUTO-GENERATED SB Admin 2 wrapper (Staff Entry – UI mejorada) */ ?>
<?php
              ...
              <form id="staffForm" action="staff_agregado.php" method="POST" novalidate>
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input id="fullname" name="fullname" type="text" class="form-control" placeholder="Ej: María López"
                      required>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <input id="username" name="username" type="text" class="form-control" placeholder="Ej: mlopez"
                        required>
                  ...
                  <div class="col-md-6">
                    ...
                    <input id="password2" name="password2" type="password" class="form-control"
                      placeholder="Repítela exactamente" required>
                ...
                <div class="row g-3">
                  <div class="col-md-6">
                    ...
                    <input id="email" name="email" type="email" class="form-control" placeholder="nombre@dominio.com"
                      required>
                  ...
                  <div class="col-md-6">
                    ...
                    <input id="contact" name="contact" type="tel" inputmode="numeric" pattern="[0-9]{6,15}"
                      class="form-control" placeholder="Ej: 76543210" required>
                  ...
                  <div class="col-md-8">
                    ...
                    <input id="address" name="address" type="text" class="form-control"
                      placeholder="Calle, número, zona" required>
...
<style>
  ...
  .show-invalid .invalid-feedback {
    display: block;
  }

  .show-invalid .is-invalid+.invalid-feedback {
    display: block;
  }
