...
$query = "SELECT * FROM planes ORDER BY estado DESC, nombre ASC";
...
<div class="sb2-content d-flex flex-column min-vh-100">
  <div class="container-fluid flex-grow-1 py-3">
    ...
    <style>
      ...
      .plan-table th.text-left {
        text-align: left !important;
      }

      .plan-table td.text-right,
      .plan-table th.text-right {
        ...
        <div class="card shadow mb-4 plan-card">
          <div class="card-header py-3 d-flex align-items-center justify-content-between flex-wrap gap-2">
            ...
            <div class="d-flex align-items-center gap-3">
              ...
              <a href="plan_form.php" class="btn btn-sm btn-light font-weight-bold btn-new-plan">
                      ...
                      <tr>
                        ...
                        <td class="actions">
                          <div class="btn-group btn-group-sm" role="group">
                            ...
                            <!-- EDITAR -->
                            <a href="plan_form.php?id=<?= (int) $row['id']; ?>" class="btn btn-outline-warning btn-edit-plan"
