...
/* ================= DATOS CLIENTE ================= */
$stmt = $db->prepare("SELECT * FROM members WHERE user_id = ? LIMIT 1");
...
/* ================= MEMBRESÍA DINÁMICA ================= */
$m = membership_last($db, $user_id);
$estadoKey = membership_status($m);
$estadoText = membership_status_text($m);

$statusConfig = [
    'activa' => ['class' => 'success', 'icon' => 'fa-check-circle'],
    'por_vencer' => ['class' => 'warning', 'icon' => 'fa-exclamation-triangle'],
    'vencida' => ['class' => 'danger', 'icon' => 'fa-times-circle'],
    'secondary' => ['class' => 'secondary', 'icon' => 'fa-clock']
];

$conf = $statusConfig[$estadoKey] ?? $statusConfig['secondary'];
$planNombre = $m['plan_nombre'] ?? 'Sin Plan';
$fechaInicio = ($m && isset($m['start_date'])) ? $m['start_date']->format('d/m/Y') : '—';
$fechaFin = membership_end_date($m); // Asumiendo que devuelve string o ajusta formato
            ...
            <div class="card shadow mb-4 border-bottom-<?= $conf['class']; ?>">
                <div class="card-body pt-5">
                    <div class="text-center">
                        <div class="mb-4">
                            <i
                                class="fas fa-user-circle fa-6x text-<?= $conf['class']; ?> shadow-sm rounded-circle"></i>
                        </div>
                    ...
                    <div class="border-top pt-3">
                        <div class="row no-gutters align-items-center mb-2">
                            ...
                            <div class="col">
                                <small class="text-xs font-weight-bold text-uppercase text-muted">Carnet de
                                    Identidad</small>
        ...
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="row justify-content-start">
                ...
                <div class="col-6 col-md mb-4">
                    <a href="pago_cliente.php?id=<?= $user_id; ?>"
                        class="card border-left-primary shadow h-100 py-2 text-decoration-none bg-hover-light">
                ...
                <div class="col-6 col-md mb-4">
                    <a href="pagos_cliente.php?user_id=<?= $user_id; ?>"
                ...
                <div class="col-6 col-md mb-4">
                    <a href="asistencia_cliente.php?user_id=<?= $user_id; ?>"
                ...
                <div class="col-6 col-md mb-4">
                    <a href="recibos_cliente.php?user_id=<?= $user_id; ?>"
                        class="card border-left-dark shadow h-100 py-2 text-decoration-none">
                        <div class="card-body text-center">
                ...
                <div class="col-6 col-md mb-4">
                    <a href="ver_reporte_cliente.php?user_id=<?= $user_id; ?>"
                    ...
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col">
                            <div class="small text-gray-600">
                                <strong>Nota:</strong> Los estados de membresía se actualizan automáticamente según la
                                fecha actual. Para renovaciones, use el botón <strong>Nuevo Pago</strong>.
                            </div>
                        </div>
                    </div>
                </div>
