<?php /* admin/recibo_cliente.php — Recibo (NORMALIZADO A payments) */ ?>
<?php
// ===== SEGURIDAD ADMIN =====
...
// Usar el mismo dominio/host por el que accede el usuario
$scheme = (!empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] !== 'off') ? 'https' : 'http';
$host = $_SERVER['HTTP_HOST'];
$url = sprintf("%s://%s/checkin.php?gym=%d&t=%d&sig=%s", $scheme, $host, GYM_ID, $slot, $sig);

$pageTitle = $pageTitle ?? 'Recibo';
...
if ($payment_id <= 0) {
    ...
    include __DIR__ . '/theme/sb2/footer.php';
    exit;
}
/* ===============================
