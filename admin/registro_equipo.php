            ...
            <div class="row eq-row">
              <div class="col-lg-6">
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control" id="ename" name="name" placeholder="Nombre del equipo"
                    required>
                </div>
              ...
              <div class="col-lg-6">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="text" class="form-control" id="contact" name="contact" minlength="8" maxlength="15"
                    placeholder="Ej: 72078787" required>
