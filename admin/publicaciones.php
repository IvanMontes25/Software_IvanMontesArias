<?php /* AUTO-GENERATED SB Admin 2 wrapper (mejorado) */ ?>
<?php
      ...
      <div class="card shadow mb-4 post-card">
        ...
        <div class="card-header py-3 d-flex align-items-center justify-content-between flex-wrap">
          ...
          <div class="post-header-actions">
            ...
            <a href="admin_publicacion.php" class="btn btn-outline-light btn-sm btn-admin-post">
        ...
        <div class="card-body">
          ...
          <form id="postForm" action="post_publicacion.php" method="POST" enctype="multipart/form-data" novalidate>
            ...
            <div class="mb-3">
              ...
              <textarea class="textarea_editor form-control" name="message" rows="6" maxlength="1000" required
            ...
            <div class="row">
              <div class="col-md-6 mb-3">
                <div class="form-card">
                  ...
                  <input class="form-control" type="date" name="date" min="<?php echo $hoy; ?>"
                    value="<?php echo $hoy; ?>">
                </div>
              </div>
